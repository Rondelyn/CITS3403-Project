...
image6  = image(image_url= "https://images.unsplash.com/photo-1709655429303-ee5d00cbbf85?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", image_catagroy= "fit", user_id="john", image_id=6, image_likes=0)
...
db.session.add_all([image1,image2,image3,image4,image5, image6,user1])
db.session.commit()
